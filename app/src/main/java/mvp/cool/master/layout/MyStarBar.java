...
public class MyStarBar extends View {
    ...
    public MyStarBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MyStarBar(Context context, AttributeSet attrs, int defStyleAttr) {
